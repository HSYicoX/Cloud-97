      ...
      <section id="blogs" className="py-20 px-6 bg-slate-800/20 backdrop-blur-sm">
        <div className="container mx-auto">
            ...
            id: blog.id
                ...
                <CardContent>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <ArrowRight className="h-4 w-4 text-blue-400 group-hover:translate极-x-1 transition-transform duration-200" />
                  </div>
                </CardContent>
              </Card>)}
          </div>
          ...
          <div className="text-center mt-12">
            <Button variant="outline" className="border-slate-600 text-slate-300 hover:bg-slate-800 hover:text-white px-8 py-4 rounded-xl transition-all duration-300 hover:scale-105" onClick={() => handleNavigate('blogs')} disabled={isNavigating} isLoading={isNavigating}>
              查看所有博客
            </Button>
          </div>
        </div>
